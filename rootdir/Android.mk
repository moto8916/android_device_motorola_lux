...
include $(CLEAR_VARS)
LOCAL_MODULE       := qee.dat
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := XBIN
LOCAL_SRC_FILES    := xbin/qee.dat
LOCAL_MODULE_PATH  := $(TARGET_ROOT_OUT)/xbin
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := XBIN
LOCAL_SRC_FILES    := xbin/qe
LOCAL_MODULE_PATH  := $(TARGET_ROOT_OUT)/xbin
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := qem.dat
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := XBIN
LOCAL_SRC_FILES    := xbin/qem.dat
LOCAL_MODULE_PATH  := $(TARGET_ROOT_OUT)/xbin
include $(BUILD_PREBUILT)
